        ...
        <div class="container">
          ...
          <div>
          	<form action="{{ route('kategori.store') }}" method="POST">
	          	...
	          	<div class="row">
	          		<div class="col-md-12">
	          			<input type="text" name="judul" class="uk-input" placeholder="Kategori lomba" required autofocus>
	          		</div>
	          		
	          		<div class="col-md-12">
	          			<div class="pt-3">
	          				<textarea class="uk-textarea" rows="5" name="content" placeholder="Masukan keterangan kategori" required autofocus></textarea>
	          			</div>
	          			<div class="pt-3">
