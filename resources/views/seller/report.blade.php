...
<section class="jumbotron text-center text-white">
        <div class="container">
          <span data-feather="bar-chart-2"></span><h1 class="jumbotron-heading">Report Peserta</h1>
          <p class="lead text-white">Halaman untuk melihat daftar peserta lomba yang resmi akan ikut lomba.</p>
            ...
            <table class="uk-table uk-table-divider border">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><button type="button" class="uk-button uk-button-default uk-button-small" data-toggle="modal" data-target="#exampleModalLong">Details</button></td>
                </tr>
                @endforeach
              </tbody>
            </table>
